...
# -------------------------------------------------------------
st.set_page_config(page_title="OMNISCIENCE | Threat Analytics", page_icon="👁️", layout="wide", initial_sidebar_state="collapsed")
...
st.markdown('<div class="title-container"><h1 class="neon-text">👁️ OMNISCIENCE</h1><p class="subtitle">Real-time Impossible Travel Detection & Geolocation Analytics</p></div>', unsafe_allow_html=True)
